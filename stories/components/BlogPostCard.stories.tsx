...
const meta: Meta<typeof BlogPostCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Component documentation for BlogPostCard",
      },
    },
  },
  argTypes: {},
...
const Template = (args: React.ComponentProps<typeof BlogPostCard>) => 
  React.createElement(BlogPostCard, args);
...
export const DevOpsCategory: Story = {
  render: Template,
  args: {
    post: {
      id: 3,
